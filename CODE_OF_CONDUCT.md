...
requests, discussions) for this repository and
[`Jamyn/dispatch-docker`](https://github.com/Jamyn/dispatch-docker), and
...
[private security advisory](https://github.com/Jamyn/dispatch/security/advisories/new)
or, for non-security conduct reports, by contacting
[@Jamyn](https://github.com/Jamyn) directly through GitHub. All complaints
...
1. **Correction** — A private, written warning, providing clarity around the
   ...
   inappropriate.
2. **Warning** — A warning with consequences for continued behavior, with no
