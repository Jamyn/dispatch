...
You can view the full API documentation for the `/instances` endpoint in the [API Reference](https://jamyn.github.io/dispatch/docs/api#tag/signals/operation/create_signal_instance__organization__signals_instances_post).
...
**Variant**: The same signal can have multiple variants with different definitions.

**Owner**: Typically the team or owner that produces the Signal.
