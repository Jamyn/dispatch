...
- Run `docker/dev-setup.sh` first if you have not already — it generates the
  development secrets into `docker/.env`, which the script below reads.
...
- Update GitHub releases: https://github.com/Jamyn/dispatch/releases
- Publish the release
